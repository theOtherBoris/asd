  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li class="active "><a><span class="glyphicon glyphicon-home"></span>  Home <span class="sr-only">(current)</span></a></li>
        <li class="dropdown">
          <a href="" class="dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Gestione Profilo Azienda<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="ModificaDatiAzienda">Modifica Dati</a></li>
            <li class="divider"></li>
		...
		<div class=" col-md-3 col-sm-2 ">
			...
			<p><big>Benvenuto <c:out value="${nome}"/></big><br> </p>
			</div>
		<div class=" col-md-3 col-sm-2 ">
		</div>
		</div>
