...
<div style="padding-top:50px">
	...
	<h1>Sanitaria.it</h1>
	<h2>Elenco Prenotazioni Attive</h2>
...
<table class=" table table-bordered table-hover tabella">
  ...
  <tbody>
      ...
      <c:forEach items="${listaPrenotazioniAttive}" var="i" varStatus="status">
		<tr>
			<td><c:out value="${status.count}"/></td> 
			<td> <c:out value="${i.nomeEsame}"/></td>
			<td> <c:out value="${i.nomeAzienda}"/></td>
			
			<td> <c:out value="${i.costoEsame}"/></td>
			<td> <c:out value="${i.dataEsame}"/></td>
			<td><a href="">
